...
class TestMorse(TestCase):
    def test_str(self):
        ...
        self.assertEqual(text2morse("Привет"), ".--. .-. .. .-- . -")
    ...
    def test_wrong_lang(self):
        ...
        with self.assertRaises(ValueError):
            text2morse("Привет", "ger") #вызываем функция с неверными данными для проверки сообщения об ошибке

    def test_instance(self):
        # Проверьте типы возвращаемых значений
        self.assertIs(type(text2morse("Привет")), str) #Сравниваем тип вовращенного значения со стринг


# text = "Привет"
# converted = text2morse(text, lang="ru")
# print(f"Ваш текст азбукой Морзе будет: {converted}!")
# converted = text2morse("Hello", lang="en")
# print(f"Ваш текст азбукой Морзе будет: {converted}!")